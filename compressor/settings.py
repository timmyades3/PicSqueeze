...
AWS_ACCESS_KEY_ID = os.environ.get('COMPRESSOR AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = os.environ.get('COMPRESSOR AWS_SECRET_ACCESS_KEY')
AWS_STORAGE_BUCKET_NAME = os.environ.get('COMPRESSOR AWS_STORAGE_BUCKET_NAME')
AWS_S3_SIGNATURE_NAME = 's3v4',
AWS_S3_REGION_NAME = os.environ.get('COMPRESSOR AWS_S3_REGION_NAME')
